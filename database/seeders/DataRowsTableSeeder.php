    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                'id' => 36,
                'data_type_id' => 5,
                'field' => 'database_config_id',
                'type' => 'text',
                'display_name' => 'Database Config Id',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
            ...
            array (
                'id' => 40,
                'data_type_id' => 5,
                'field' => 'website_user_belongsto_database_config_relationship',
                'type' => 'relationship',
                'display_name' => 'database_configs',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\DatabaseConfig","table":"database_configs","type":"belongsTo","column":"database_config_id","key":"id","label":"configname","pivot_table":"data_rows","pivot":"0","taggable":"0"}',
                'order' => 10,
            ),
        ));
